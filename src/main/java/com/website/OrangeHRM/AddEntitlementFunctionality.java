...
public class AddEntitlementFunctionality extends OrangeHRMBase{

	
	
	public void AddEntitlementSectionOne() {
		try {
			...
			driver.findElement(By.xpath("//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/div/form/div[3]/div/div[3]/div/div[2]/input")).sendKeys(prop.getProperty("Entitlement"));
